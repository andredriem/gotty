...
type Options struct {
	...
	ClientIp            string           `hcl:"client_ip" flagName:"client-ip" flagDescribe:"Allows server only to accept connection from a single provided IP. All IPs are accetable by default." default:""`
